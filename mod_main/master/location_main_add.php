            ...
            $(document).ready(function(){
                $('#btnsubmit').click(function(event) {
                    ...
                    if(error_msg.length != 0){
                        ...
                        $("#form1").attr('action','location_main_add_save.php');
                ...
                $("#btnclose").click( function(){
                    var mainP = parent.document.getElementById('scawindow');
                    mainP.close();
                }
            );
            });
    ...
    <body>
        ...
        <form  id="form1" action="" method="post">
            <ul class="form-style-1">
                <li>
                    <label for="name">Location Main Code<span class="required">*</span></label>
                    <input type="text" id="txtcode" name="code"  maxlength="2" value="" class="field-long"/>
                </li>
                <li>
                    <label for="name">Location Main Description<span class="required">*</span></label>
