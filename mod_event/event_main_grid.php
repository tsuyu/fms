...
<br/>
<div align="right">
    <button class="pure-button pure-button-primary_r" onclick="ns.calendar(); return false" type="button" id="btnsubmit">Calendar View</button>
...
<table class="pure-table" width="100%">
    ...
    <tbody>
        ...
        $sql = "SELECT DATE_FORMAT(`ebm_from_date`,'%d-%m-%Y'),TIME_FORMAT(`ebm_from_date`, '%h:%i%p'),DATE_FORMAT(`ebm_to_date`,'%d-%m-%Y'),TIME_FORMAT(`ebm_to_date`, '%h:%i%p'),`aum_name`, `ebm_purpose`,`ebm_status`
                ...
                AND `aum_username` = `ebm_requestor_id` AND `ebm_location_id` = `lmd_seq_no` ";
        ...
        <tr <?php echo $odd;?>>
            ...
            <td>
                <button class="pure-button pure-button-primary_g" onclick="ns.approve(); return false" type="button" id="btnsubmit">Approval</button>
            </td>
        </tr>
            <?php $y++;
        }
...
<script type="text/javascript">
    ...
    namespace = {
        ...
        reset : function(){
            location.href = "home.php?mod=u2&app=74z554f4y564g4a4f4w544g4m4c444";
        },
        back : function(){
    ...
    $(document).ready(function() {
        $("#search").click( function(){
            $("#mode").val("search");
            $("#form2").attr('action','home.php?mod=u2&app=74z554f4y564g4a4f4w544g4m4c444');
