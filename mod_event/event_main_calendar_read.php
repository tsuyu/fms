...
$sql = "SELECT `ec_seq_no`,`ec_title`,`ec_startdate`, `ec_enddate`,`ec_all_day` FROM `event_calendar`";
$stmt = $db->prepare($sql);
$stmt->execute();
$stmt->store_result();
$stmt->bind_result($ec_seq_no,$ec_title,$ec_startdate,$ec_enddate,$ec_allDay);
