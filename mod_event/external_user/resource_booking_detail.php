    ...
    <table class="pure-table2" width="100%">
        ...
        <tbody>
            <tr class = "pure-table2-odd">
                <td colspan="4"><b>Search for particular period</b></td>
            </tr>
            <tr>
                <td width="30%"></td>
...
$stmt = $db->prepare("SELECT `lmd_seq_no`,`lmd_name`,`lmd_desc`,`lmd_capacity` FROM `location_main_detail` WHERE lmd_seq_no = ?");
...
<table class="pure-table2" width="100%">
    ...
    <tbody>
        <tr class = "pure-table2-odd">
            <td colspan="4"><b>Resource detail</b></td>
        </tr>
        <tr>
            <td width="30%" colspan="3" align="right">Name</td>
            <td><b><?php echo $lmd_name;?></b></td>
        </tr>
        <tr>
            <td width="30%" colspan="3" align="right">Description</td>
            <td><?php echo $lmd_desc;?></td>
        </tr>
    </tbody>
</table>
    <?php } ?>
<br/>
<div align="right">
    <button class="pure-button pure-button-primary_g" onclick="ns.book(<?php echo $_GET['id']; ?>); return false" type="button" id="btnsubmit">Book</button>
    <button class="pure-button pure-button-primary_r" onclick="ns.calendar(<?php echo $_GET['id']; ?>); return false" type="button" id="btnsubmit">Calendar View</button>
...
<table class="pure-table" width="100%">
    ...
    <tbody>
        ...
        $sql = "SELECT DATE_FORMAT(`ebm_from_date`,'%d-%m-%Y'),TIME_FORMAT(`ebm_from_date`, '%h:%i%p'),DATE_FORMAT(`ebm_to_date`,'%d-%m-%Y'),TIME_FORMAT(`ebm_to_date`, '%h:%i%p'),`aum_name`, `ebm_purpose`,`ebm_status`
                ...
                AND `aum_username` = `ebm_requestor_id` AND `ebm_location_id` = `lmd_seq_no` AND `ebm_location_id` = ? ";
...
<script type="text/javascript">
    ...
    namespace = {
        calendar : function(id) {
            var view_event_win=dhtmlwindow.open("view_event_box", "iframe", "./mod_event/external_user/resource_booking_calendar.php?id="+id, "View Event", "width=800px,height=500px,resize=1,scrolling=1,center=1", "recal")
        },
        book : function(id){
            location.href = "home.php?mod=u2&app=k4i5j4g4z5p464e454k5k4o4f4c4e4l54484m4i4u5&id="+id;
        },
        reset : function(id){
            location.href = "home.php?mod=u2&app=k4i5j4g4z5p464e454k5k4o4f4c4e4l54464c4k4i5m5u5&id="+id;
        },
        back : function(){
            location.href = "home.php?mod=u2&app=k4i5j4g4z5p464e454k5k4o4f4c4e4l544e4m434i5x5r5v5j4";
        }
    };
    window.ns = namespace;
    ...
    $(document).ready(function() {
        $("#search").click( function(){
            $("#form2").attr('action','home.php?mod=u2&app=k4i5j4g4z5p464e454k5k4o4f4c4e4l54464c4k4i5m5u5&id='+<?php echo $_GET['id']; ?>);
