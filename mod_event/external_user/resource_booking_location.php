<div class="table-container">
    ...
    <table class="pure-table" width="100%">
        ...
        <tbody>
            ...
            $stmt = $db->prepare("SELECT `lmd_seq_no`,`lmd_name`,`lmd_desc`,`lmd_capacity` FROM `location_main_detail` WHERE 1 AND `lmd_booking` = 'Y'");
            $stmt->execute();
            ...
            <tr <?php echo $odd;?>>
                ...
                <td>
                    <button class="pure-button pure-button-primary_g" onclick="ns.book(<?php echo $lmd_seq_no;?>); return false" type="button" id="btnsubmit">Book</button>
                </td>
            </tr>
                <?php $y++;
            }
