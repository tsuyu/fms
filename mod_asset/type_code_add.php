    ...
    $(document).ready(function(){
        $('#btnsubmit').click(function(event) {
            ...
            $('#txtdescription').validator({
                fieldLabel : '- Type Code Description',
                invalidEmpty: true,
                noSpaceFirstLast: true,
                format: 'alphanumeric',
                error: function(stat,type,msg) {
		...
		for(var i=0; i<len; i++){
                ...
                $("#form1").attr('action','type_code_add_save.php');
        ...
        $("#btnclose").click( function(){
             var mainP = parent.document.getElementById('tcawindow');
             mainP.close();
           }
        );
});  
...
<ul class="form-style-1">
    <li>
   <label for="name">Type Code<span class="required">*</span></label>
